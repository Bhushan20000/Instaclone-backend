...
mongoose.connect(process.env.DATABASE_URL || "mongodb+srv://rootuser:Bhushan20@cluster0.u3mqadc.mongodb.net/?retryWrites=true&w=majority/test").
then(() => {
...
app.get("/", (req, res) => {
    res.send("InstaClone Backend By Bhushan Patil")
})
